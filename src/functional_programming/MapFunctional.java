...
public class MapFunctional {
	...
	public static void main(String[] args) {
		...
		List<String> list = Arrays.asList("billy", "tommy  ", " rick  ", "abdul", "albert     ", "isaiah");
	...
	/**
	 * Imitation of more sophisticated map method in Java 8. The method named by
	 * methodname must have a single String argument and must return a String.
	 */
