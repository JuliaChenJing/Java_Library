...
public class ProfileWindow extends JFrame {
	...
	private void defineTopPanel() {
		...
		JPanel streetPanel = createTextPanel(labelFirstName, firstNameField);
		
		JLabel labelLastName = new JLabel("Last Name");
		labelLastName.setFont(makeSmallFont(labelLastName.getFont()));
		lastNameField = new JTextField(12);
		JPanel cityPanel = createTextPanel(labelLastName, lastNameField);
	...
	private void defineBottomPanel() {
		...
		button = new JButton("Update Personal Info");
	...
	class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent evt){
				...
				String favoriteRestaurant= favoriteRestaurantField.getText();
				...
				try {
					...
					String output = name + n + firstname + n + lastname + ", "+favoriteMovie+" "+favoriteRestaurant;
